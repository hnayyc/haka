 ...
 * SPDY frames flowing in and out using the {@link com.hnayyc.netty.example.spdy.client.SpdyFrameLogger}.
 *
 * <p>
 ...
 * <p>
 * To start, run {@link com.hnayyc.netty.example.spdy.server.SpdyServer} with the JVM parameter:
 ...
 * information.
 * <p>
 * After that, you can run {@link com.hnayyc.netty.example.spdy.client.SpdyClient}, also settings the JVM parameter
 * mentioned above.
 * <p>
 ...
 * </pre>
 */
package com.hnayyc.netty.example.spdy.client;
